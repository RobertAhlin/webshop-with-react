...
**Product images**
At this stage there are only dummy images for the the products generated by DummyJSON as if there where real images, just to show that the API handles images for each product.  
